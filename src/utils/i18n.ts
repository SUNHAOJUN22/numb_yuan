...
export interface TranslationSet {
  ...
  easterEggBtn: string;
  jiaoTerminalTitle: string;
  jiaoHelpBtn: string;
  jiaoHelpUsed: string;
  jiaoHelpNoTarget: string;
  jiaoQuoteIdle: string;
  jiaoQuotePlaying: string;
  jiaoQuoteWin: string;
  jiaoQuoteLose: string;
  challengeModeTitle: string;
  jiaoStreakText: string;
  extraMinesText: string;
}
...
export const translations: Record<Language, TranslationSet> = {
  'zh-CN': {
    ...
    goalTitle: '核心目标',
    goalDesc: '扫除整个棋盘里一切未知的土壤，小心地标出红旗，绝对不可踩到任何一个“袁子弹”！踩中则个袁世杰闹全麻。',
    controlsTitle: '全面触控与按键指令',
    unearthTitle: '地块开掘 (刨土铲子)',
    unearthDesc: '左键单击（桌面端）或直接轻触（移动端）。排查并显示周围相邻 8 格中藏有的“袁子弹”累积数量。',
    flagTitle: '设置标旗 (避险防护)',
    ...
    loseOverDesc: '大意踩雷！深藏地底的“袁子弹”暴雷了，这下真是个袁世杰闹了全麻，推不回朝阳了。',
    playAgainBtn: '再闹一把',
    viewStatsBtn: '查看生涯',
    ...
    easterEggBtn: '椒哥特制彩蛋 🥚',
    jiaoTerminalTitle: '椒哥极智云端实时诊断中心',
    jiaoHelpBtn: '⚡ 椒哥助我！(极智安全排雷)',
    jiaoHelpUsed: '椒哥警告：协助充能中！请耐心等待极智排雷节点重置，或依靠自己的智慧继续排查。',
    jiaoHelpNoTarget: '椒哥长叹：场上暂时没有把握十足的非雷安全地块了，全靠你的逆天微操了！',
    jiaoQuoteIdle: '袁世杰说他要在朝阳摆摊了，快去阻止他！敲开任意地块，触发首击绝对抗爆屏蔽！',
    jiaoQuotePlaying: '正在实时推演局势... 高能“袁子弹”物质在颤动，注意安全。',
    jiaoQuoteWin: '不愧是跟椒哥混的！华宇的学位证书已生成临时 PDF 并发送到你的云端！🎉',
    jiaoQuoteLose: '个袁世杰闹全麻！别气馁，点击[再闹一把]，椒哥再带你冲锋！',
    challengeModeTitle: '椒哥微操挑战模式',
    jiaoStreakText: '极智连胜',
    extraMinesText: '追加高能雷',
  },
  'zh-TW': {
    title: '袁世傑鬧麻了',
    ...
    goalTitle: '核心目標',
    goalDesc: '掃除整個棋盤裡一切未知的土壤，小心地標出紅旗，絕對不可踩到任何一個「袁子彈」！踩中則個袁世杰鬧全麻。',
    controlsTitle: '全面觸控與按鍵指令',
    unearthTitle: '地塊開掘 (刨土鏟子)',
    unearthDesc: '左鍵單擊（桌面端）或直接輕觸（移動端）。排查並顯示周圍相鄰 8 格中藏有的「袁子彈」累積數量。',
    flagTitle: '設置標旗 (避險防護)',
    ...
    loseOverDesc: '大意踩雷！深藏地底的「袁子彈」暴雷了，這下真是個袁世杰鬧了全麻，推不回朝陽了。',
    playAgainBtn: '再鬧一把',
    viewStatsBtn: '查看生涯',
    ...
    easterEggBtn: '椒哥特製彩蛋 🥚',
    jiaoTerminalTitle: '椒哥極智雲端即時診斷中心',
    jiaoHelpBtn: '⚡ 椒哥助我！(極智安全排雷)',
    jiaoHelpUsed: '椒哥警告：協助充能中！請耐心等待極智排雷節點重置，或依靠自己的智慧繼續排查。',
    jiaoHelpNoTarget: '椒哥長嘆：場上暫時沒有把握十足的非雷安全地塊了，全靠你的逆天微操了！',
    jiaoQuoteIdle: '袁世傑說他要在朝陽擺攤了，快去阻止他！敲開任意地塊，觸發首擊絕對抗爆屏蔽！',
    jiaoQuotePlaying: '正在即時推演局勢... 高能「袁子彈」物質在顫動，注意安全。',
    jiaoQuoteWin: '不愧是跟椒哥混的！華宇的學位證書已生成臨時 PDF 並發送到你的云端！🎉',
    jiaoQuoteLose: '個袁世杰鬧全麻！別氣餒，點擊[再鬧一把]，椒哥再帶你衝鋒！',
    challengeModeTitle: '椒哥微操挑戰模式',
    jiaoStreakText: '極智連勝',
    extraMinesText: '追加高能雷',
  },
  'en': {
    ...
    playingStatus: 'Carefully searching... avoid the "Yuan Bullet" mines',
    ...
    goalDesc: 'Sweep all dirt and unearth numbers without triggering any hidden "Yuan Bullet" mines underneath! Set flags to seal locations.',
    controlsTitle: 'High Compatibility Commands',
    unearthTitle: 'Unearth Grid (Shovel Tool)',
    unearthDesc: 'Left Click on desktops or tap in Shovel mode. Numbers specify how many "Yuan Bullet" mines are near.',
    ...
    loseOverDesc: 'Oops! Hit a "Yuan Bullet" mine. Jiao Ge is speechless. Yuan Shijie is completely paralyzed and cannot push his cart back to Chaoyang!',
    ...
    jiaoTerminalTitle: "Jiao Ge's AI Diagnostic Node",
    jiaoHelpBtn: '⚡ Call Jiao Ge! (Smart Scan)',
    jiaoHelpUsed: 'Jiao Ge capacity limit: Wait for Smart Scan charges to replenish! Rely on your own wits for now.',
    jiaoHelpNoTarget: 'Jiao Ge sighs: There are currently no 100% safe unrevealed blocks on the grid. Show off your micro-controls!',
    jiaoQuoteIdle: 'Yuan Shijie is about to set up a cart in Chaoyang. Go stop him! Click any grid tile to trigger Jiao Ge\'s absolute explosive shield!',
    jiaoQuotePlaying: 'Real-time analysis in progress... Extreme "Yuan Bullet" energy signals detected. Watch your step!',
    jiaoQuoteWin: "Splendid! As expected of Jiao Ge's follower. Huayu's graduation degree has been generated as a temporary PDF and beamed to your ledger! 🎉",
    jiaoQuoteLose: 'Yuan Shijie has completely paralyzed! Don\'t sweat it, press [Restart Grid] to strike back under Jiao Ge\'s wings!',
    challengeModeTitle: "Jiao's Micro Challenge",
    jiaoStreakText: 'Active Streak',
    extraMinesText: 'Extra Mines Activated',
  }
};
